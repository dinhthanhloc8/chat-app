            ...
            <Dialog open={previewFilePopUp}>
                ...
                >
                    {previewFileObj.map((e, index) => (
                        <div className="h-[120px] bg-[var(--white)] w-[100%] rounded-xl mb-2 flex items-center p-[10px_20px] relative">
                            <div className="w-[24%] relative">
                                <InsertDriveFileIcon className="text-[var(--primary)] !text-[6rem]" />
                            ...
                            <div className="w-[60%]">
                                <p className="text-[1.2rem] text-[var(--black)] w-[100%] truncate">
                                    {e.name}
                                </p>
