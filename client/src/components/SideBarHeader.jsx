    ...
    return (
        <div className="flex relative justify-between items-center p-[10px_0]">
            {!search && (
                ...
                >
                    <MenuIcon
                        className="cursor-pointer text-[var(--black)] !text-[1.6rem]"
                        fontSize="large"
                    ></MenuIcon>
                </IconButton>
            )}
            ...
            {openMenu && (
                <div ref={menuRef}>
                    ...
                    >
                        ...
                        >
                            <ListItemIcon>
                                <AccountCircleIcon className="text-[var(--black)]" />
                            </ListItemIcon>
                            <ListItemText
                                primary="Profile"
                        ...
                        >
                            <ListItemIcon>
                                <AddCircleIcon className="text-[var(--black)]" />
                            </ListItemIcon>
                            <ListItemText
                                primary="New group"
                                className="text-[var(--black)]"
                        ...
                        >
                            <ListItemIcon>
                                <LogoutIcon className="text-[var(--black)]" />
                            </ListItemIcon>
                            <ListItemText
                                primary="Log Out"
                                className="text-[var(--black)]"
                ...
                <TextField
                    ...
                    InputProps={{
                        ...
                        startAdornment: (
                            ...
                            >
                                <SearchIcon className="text-[var(--black)]" />
                            </InputAdornment>
                        ),
                        endAdornment: (
                            <>
                                {filled && (
                                    ...
                                    >
                                        <ClearIcon className="!text-[var(--black)]" />
                                    </InputAdornment>
                                )}
                            </>
                        ),
            ...
            {search && (
                <div className='className="flex flex-col bg-[var(--white)] absolute top-[100%] h-[calc(100vh-100%-28px)] w-[100%] z-[999] overflow-y-scroll p-[20px] rounded-2xl'>
                    {data.map((e) => (
                        <SearchResultCard
                            data={e}
