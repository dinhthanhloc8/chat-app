...
function ConversationBox() {
    ...
    const handleRenderMessage = (messages) => {
        ...
        return messages.map((e, index, arr) => {
            ...
            return (
                <>
                    {presentTime && (
                        <div className="relative border-b-[1px] border-b-[var(--white-2)] w-[100%] mt-6 mb-4">
                            <p className="absolute bottom-[-12px] bg-[var(--white)] right-[50%] translate-x-[50%] text-[var(--white-2)] text-center p-[0_10px]">
    ...
    return (
        <div
            ...
            } flex ml-[0] md:ml-[10px]`}
        >
            <div className="h-full flex flex-col flex-1 rounded-md  bg-[var(--white)] p-[14px_0]">
                ...
                <div
                    className="flex-1 flex flex-col-reverse p-[10px_20px] overflow-y-scroll overflow-x-hidden bg-[var(--white)] rounded-2xl"
                    onScroll={handleScroll}
                >
                    {loadingFiles.map((e, i) => (
                        <LoadingFile key={i} data={e} />
                    ))}
