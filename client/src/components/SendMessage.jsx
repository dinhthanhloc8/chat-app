            ...
            <FormControl className="flex-1 relative">
                ...
                {openUploadOptions && (
                    <div
                        ...
                        className="absolute bg-[var(--white)] min-w-[160px] bottom-[100%] right-0 mb-[10px] rounded-xl text-white z-[99] shadow-md shadow-[var(--black-2)]"
                    >
                        <List className="text-[var(--black)]">
                            <ListItemButton
                                onClick={(e) => {
                                    document
